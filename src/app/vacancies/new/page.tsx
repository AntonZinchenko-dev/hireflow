  ...
  return (
    <section className="mx-auto grid max-w-4xl gap-6 lg:grid-cols-[1.1fr_0.9fr]">
      <div className="hf-card p-7">
        ...
        <h1 className="mt-2 text-3xl font-semibold tracking-tight text-foreground">Новая вакансия</h1>
      ...
      <aside className="hf-card-tight p-6">
        <h2 className="text-lg font-semibold text-foreground">Что будет дальше</h2>
